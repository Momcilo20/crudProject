...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" class="fw-bold">
 ...
 <h1 class="text-white text-center">  Azuriraj </h1>
 </div><br>
 ...
 <button class="btn btn-success" type="submit" name="submit"> Primjeni </button><br>
 <a class="btn btn-info" type="submit" name="cancel" href="index.php"> Zatvori </a><br>
